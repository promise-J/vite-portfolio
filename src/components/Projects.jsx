const projects = [
    {
      ...
      desc: "NestJS, Redis, RabbitMQ, MongoDB, WebSockets",
      github: "https://github.com/promise-J/uber-clone",
      live: "https",
      featured: true,
    },
    {
      title: "Dev Tracker API (Go)",
      desc: "JWT, Admin roles, uploads, audit logs",
      github: "https://github.com/promise-J/dev-tracker-api",
      live: "#",
      featured: true
    },
  ];
